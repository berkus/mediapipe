            ...
            flag_set(
                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            "-isystem",
                            "external/emscripten_wasm/upstream/emscripten/system/include",
                            "-isystem",
                            "external/emscripten_wasm/upstream/emscripten/system/include/libcxx",
                            "-isystem",
                            "external/emscripten_wasm/upstream/emscripten/system/include/libc",
                            "-isystem",
                            "external/emscripten_wasm/upstream/emscripten/system/include/emscripten",
                            "-isystem",
                            "external/emscripten_wasm/upstream/emscripten/system/lib/libc/musl/arch/emscripten",
                        ],
                    ),
                ],
            ),
