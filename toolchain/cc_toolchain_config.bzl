                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            "-isystem",
                            "/external/emscripten_toolchain/upstream/emscripten/system/lib/libcxxabi/include",
                            "-isystem",
                            ...
                            "-isystem",
                            "/external/emscripten_toolchain/upstream/emscripten/system/lib/libc/musl/arch/emscripten",
                            "-isystem",
                            "/external/emscripten_toolchain/upstream/emscripten/system/local/include",
                        ],
                    ),
                ],
            ),
